...
TEST(Solver, Wood)
{
	...
	EXPECT_LT( std::abs(x[0] - 1.0), 1e-10);
	EXPECT_LT( std::abs(x[1] - 1.0), 1e-10);
	EXPECT_LT( std::abs(x[2] - 1.0), 1e-10);
	EXPECT_LT( std::abs(x[3] - 1.0), 1e-10);
	EXPECT_LT( std::abs(fval), 1e-10);
}
